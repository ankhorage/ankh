...
`AnkhRuntimeCommandProvider` default export. Planning is a provider contract, not
workflow execution: the root CLI routes to provider planning handlers and renders
returned plans, but it does not compose real workflows, create projects, run
commands, or execute destructive steps.
